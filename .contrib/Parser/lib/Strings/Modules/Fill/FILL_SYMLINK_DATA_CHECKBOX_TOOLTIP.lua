createLocalizationString({
	...
	constant = "FILL_SYMLINK_DATA_CHECKBOX_TOOLTIP",
	export = true,
	-- This is technically a "formatted" string where %s is replaced with SYM_ROW_INFORMATION when utilized
	text = {
