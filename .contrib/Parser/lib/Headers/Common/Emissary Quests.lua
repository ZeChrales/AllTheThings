EMISSARY_QUESTS = createHeader({
	...
	description = {
		...
		-- TODO: de = "",
		es = "Estos objetos son obtenidos al completar misiones de emisario o cajas de paragón",
		mx = "Estos objetos son obtenidos al completar misiones de emisario o cajas de paragón",
