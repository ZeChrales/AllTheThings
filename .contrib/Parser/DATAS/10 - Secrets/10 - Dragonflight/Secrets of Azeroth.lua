...
SECRETS_OF_AZEROTH_HEADER = createHeader({
	...
	text = {
		...
		de = "Geheimnisse von Azeroth",
		es = "Secretos de Azeroth",
		mx = "Los Secretos de Azeroth",
		fr = "Secrets d’Azeroth",
		it = "Segreti di Azeroth",
		ko = "아제로스의 비밀",
		pt = "Segredos de Azeroth",
		ru = "Тайны Азерота",
		cn = "艾泽拉斯之秘",
		tw = "艾澤拉斯秘聞",
	},
		...
		["groups"] = {
			n(ACHIEVEMENTS, {
				...
				ach(18645, {	-- Tools of the Trade
					...
					--
					i(208149),	-- Brown Tweed Cap (COSMETIC!)
				}),
				ach(18646, {	-- Whodunnit?
					...
					title(519),	-- Honorary Preservationists <Name>
				}),
				ach(19080, {	-- Arcane Influence
					["questID"] = 78101,
					["coord"] = { 36.6, 61.8, VALDRAKKEN },
					["u"] = REMOVED_FROM_GAME,	-- No reason for timelines, it was available for two days (10/11 September 2023)
				}),
			}),
			n(TREASURES, sharedData({
				["groups"] = { i(208142) },	-- Buried Satchel
			}, {
			...
			n(QUESTS, {
				...
				q(77203, {	-- Preserving Rarities
					...
					["coords"] = {
						...
						{ 58.9, 54.1, VALDRAKKEN },	-- Chalice Placement
					},
					["groups"] = {
				...
				q(77165, {	-- A Secretive Contact
					...
					["groups"] = {
						...
						i(207956, {	-- Thunderspine Nest
							...
							["coord"] = { 46.5, 46.2, VALDRAKKEN },
							["cost"] = {
								{ "i", 201419, 5 },	-- 5x Apexis Asiago
								{ "i", 198441, 5 },	-- 5x Thunderspine Tenders
								{ "i", 205693, 5 },	-- 5x Latticed Stinkhorn
							},
						}),
						i(207814, {	-- Thought Calculating Apparatus
							["provider"] = { "n", 185548 },	-- Clinkyclick Shatterboom
							["coord"] = { 42.2, 48.6, VALDRAKKEN },
							["cost"] = { { "i", 207956, 5 } },	-- 5x Thunderspine Nest
						}),
						i(207812, {	-- Fresh Tyranha
							["cr"] = 191451,	-- Hungering Tyranha
							["coords"] = {
						...
						i(207813, {	-- Downy Helmet Liner
							...
							["cost"] = { { "i", 207812, 1 } },	-- 1x Fresh Tyranha
						}),
						q(77230, {
						...
						i(207827, {	-- Unfinished Thinking Cap
							["cost"] = {
								{ "i", 207814, 1 },	-- 1x Thought Calculating Apparatus
								{ "i", 207813, 1 },	-- 1x Downy Helmet Liner
								{ "i", 207816, 1 },	-- 1x Crystal Ocular Lenses
							},
						}),
					},
				}),
				...
				q(77237, {	-- Unfinished Thinking Cap
					...
					["groups"] = { i(206696) },	-- Tricked-Out Thinking Cap (TOY!)
				})),
				...
				q(76504, {	-- The Tricked-Out Thinking Cap
					...
					["groups"] = { i(206944) },	-- A Clue: The Thinking Cap
				})),
				...
				q(77276, {	-- An Inside Job?
					...
					["groups"] = {
						...
						o(405489, {	-- Preservationist's Locker
							...
							["groups"] = { i(208130) },	-- Maruuk Burial Banner
						}),
				...
				q(77281, {	-- Securing an Artifact
					...
					["groups"] = {
						...
						o(405513, {	-- Torch of Pyrreth
							...
							["groups"] = { i(208135) },	-- Torch of Pyrreth (QI!)
						}),
					},
				}),
				...
				q(77282, {	-- Artifact Secured
					...
					["groups"] = { i(208092) },	-- Torch of Pyrreth (TOY!)
				})),
				OneTimeAccountLocked(77522,	-- The Torch of Pyrreth (Account-Wide Lock)
				q(77263, {	-- The Torch of Pyrreth
					...
					["groups"] = {
						o(405515, {	-- Enchanted Box
							...
							["provider"] = { "i", 208092 },	-- Torch of Pyrreth
							["groups"] = { i(208107) },	-- Kathos' Field Glasses (QI!)
						}),
					},
				})),
				...
				q(77284, {	-- A Chilling Ascent
					...
					["coord"] = { 47.9, 46.8, VALDRAKKEN },
					["repeatable"] = true,
					["groups"] = { i(208137) },	-- The Clerk's Notes
				}),
				...
				q(77286, {	-- A Knowledgeable Descent
					...
					["groups"] = { i(208143) },	-- Unveiled Tablet Rubbing
				})),
				...
				q(77303, {	-- Idol Searching
					...
					["groups"] = {
						...
						o(405546, {	-- Idol of Ohn'ahra
							...
							["groups"] = { i(208145) },	-- Idol of Ohn'ahra (QI!)
						}),
					},
				}),
				OneTimeAccountLocked(77524,	-- Using the Idol (Account-Wide Lock)
				q(77304, {	-- An Idol in Hand
					...
					["groups"] = { i(207730) },	-- Idol of Ohn'ahra (TOY!)
				})),
				OneTimeAccountLocked(77524,	-- Using the Idol (Account-Wide Lock)
				...
				q(76509, {	-- Into the Sands
					...
					["groups"] = {
						...
						o(404319, {	-- Time-Lost Fragment
							...
							["groups"] = { i(208191) },	-- Time Lost Fragment (CI!)
						}),
						i(208146, {	-- Incomplete Tablet (QI!)
							["cost"] = { { "i", 208191, 3 } },	-- 3x Time Lost Fragment (CI!)
						}),
					},
				}),
				...
				q(77653, {	-- A Key Story
					...
					["groups"] = {
						...
						o(408226, {	-- Ancient Key Mold
							...
							["groups"] = { i(208827) },	-- Titan Key Mold
						}),
					},
				}),
				...
				q(77829, {	-- Reforging a Legend
					...
					["groups"] = {
						...
						o(407691, {	-- Dusty Red Pellets
							...
							["groups"] = { i(208835) },	-- Rose Gold Dust (QI!)
						}),
						o(407692, {	-- Igneous Flux
							...
							["groups"] = { i(208836) },	-- Igneous Flux (QI!)
						}),
					},
				}),
				...
				q(77831, {	-- A Key To Reforg(ing)
					...
					["cost"] = {
						{ "i", 208835, 50 },	-- 50x Rose Gold Dust (QI!)
						{ "i", 208836,  8 },	--  8x Igneous Flux (QI!)
						{ "i", 208092,  1 },	--  1x Torch of Pyrreth
					},
					["groups"] = {
						o(408754, {	-- Reforged Titan Key
							["coord"] = { 24.5, 60.7, THE_WAKING_SHORES },
							["groups"] = { i(208830) },	-- Reforged Titan Key (QI!)
						}),
						--
						iensemble(208831),	-- Tyr's Titan Key (COSMETIC)
					},
				})),
				...
				q(77977, {	-- An Ominous Artifact
					...
					["groups"] = {
						...
						o(409120, {	-- Cache of Cosmic Mysteries
							["coord"] = { 60.2, 58.7, THALDRASZUS },
							["groups"] = { i(208980) },	-- Cache of Cosmic Curiosities (QI!)
						}),
					},
				})),
			}),
			n(COMMUNITY_CLUES_HEADER, {
				header(HEADERS.Spell, 424082, {
					...
					n(210398, {	-- Enigma Ward
						...
						["provider"] = { "i", 208092 },	-- Torch of Pyrreth
						["groups"] = { i(208984) },	-- First Booster Part
					}),
