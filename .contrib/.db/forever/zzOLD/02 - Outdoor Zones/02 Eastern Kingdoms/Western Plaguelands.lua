		...
		["groups"] = {
				...
				["groups"] = {
					n(TREASURES, {
						o(403532, {	-- Bucket of Fountain Water
							...
							["coord"] = { 68.8, 78.9, MAP.WESTERN_PLAGUELANDS },
						...
						o(403535, {	-- The Deed to Andorhal
							...
							["sourceQuest"] = 76250,	-- Spectral Essence
							["coord"] = { 43.6, 69.3, MAP.WESTERN_PLAGUELANDS },
							["timeline"] = { ADDED_10_1_5 },
					...
					n(VENDORS, {
						n(11936, {	-- Artist Renfray
							...
							-- #ENDIF
							["coord"] = { 65.8, 75.4, MAP.WESTERN_PLAGUELANDS },
							["groups"] = {
						...
						n(11316, {	-- Joseph Dirte
							["provider"] = { "i" ,13544 },	-- Spectral Essence
							["description"] = "Only visible if you have the Spectral Essence equipped.",
							["coord"] = { 68.0, 74.8, MAP.WESTERN_PLAGUELANDS },
							["groups"] = {
						...
						n(11286, {	-- Magistrate Marduke
							...
							["description"] = "Only visible if you have the Spectral Essence equipped.",
							-- #ENDIF
							["coord"] = { 70.5, 74.0, MAP.WESTERN_PLAGUELANDS },
							["groups"] = {
						...
						n(11285, {	-- Rory
							...
							["description"] = "Only visible if you have the Spectral Essence equipped.",
							-- #ENDIF
							["coord"] = { 63.4, 75.6, MAP.WESTERN_PLAGUELANDS },
							["groups"] = {
						...
						n(11283, {	-- Sammy
							...
							["description"] = "Only visible if you have the Spectral Essence equipped.",
							-- #ENDIF
							["coord"] = { 69.1, 78.7, MAP.WESTERN_PLAGUELANDS },
							["groups"] = {
			...
			n(ARTIFACTS, {
				n(111122, {	-- Large Vile Slime
					...
					["coord"] = { 69.0, 45.8, MAP.WESTERN_PLAGUELANDS },
			...
			n(FLIGHT_PATHS, {
				fp(649, {	-- Andorhal, Western Plaguelands
					...
					["coord"] = { 46.6, 64.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
				}),
				fp(650, {	-- Andorhal, Western Plaguelands
					...
					["coord"] = { 39.4, 69.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
				}),
			...
			n(QUESTS, {
				...
				q(26999, {	-- A New Era for the Plaguelands
					...
					["coord"] = { 49.2, 54.9, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["groups"] = {
				...
				q(27089, {	-- Ace in the Hole
					...
					["coord"] = { 49.0, 63.7, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
				...
				q(27206, {	-- Alas, Andorhal
					...
					["qg"] = 44453,	-- Thassarian
					["coord"] = { 39.9, 69.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
				...
				q(27171, {	-- Ambushed!
					...
					["coord"] = { 53.7, 80.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
				...
				q(27002, {	-- An Audience with the Highlord
					...
					["qg"] = 11616,	-- Nathaniel Dumah
					["coord"] = { 48.1, 32.3, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
				}),
				q(27090, {	-- Andorhal, Once and For All
					["sourceQuest"] = 27089,	-- Ace in the Hole
					["qg"] = 45129,	-- Lurid
					["coord"] = { 39.3, 70.5, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
				}),
				q(27204, {	-- Aradne
				...
				{	-- Araj the Summoner
					["allianceQuestData"] = q(27164, {	-- Araj the Summoner (A)
						...
						["coord"] = { 41.2, 70.0, MAP.WESTERN_PLAGUELANDS },
					}),
					["hordeQuestData"] = q(26925, {	-- Araj the Summoner (H)
						...
						["coord"] = { 47.3, 64.4, MAP.WESTERN_PLAGUELANDS },
					}),
					["timeline"] = { ADDED_4_0_3 },
					["groups"] = {
						objective(1, {	-- 0/1 Araj's Phylactery Shard
							...
							["coord"] = { 43.9, 69.2, MAP.WESTERN_PLAGUELANDS },
							["cr"] = 1852,	-- Araj the Summoner
						}),
					},
				},
				...
				q(27086, {	-- Ashes to Ashes (H)
					...
					["coord"] = { 46.9, 63.8, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
				...
				q(27154, {	-- Bagging Bisp
					...
					["groups"] = {
						objective(1, {	-- Magus Bisp "spoken with"
							...
							["coord"] = { 45.8, 18.6, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				applyclassicphase(SOD_PHASE_FOUR, n(createHeader({	-- Bless the Fallen
					...
					["coord"] = { 44.6, 46.6, MAP.WESTERN_PLAGUELANDS },
				...
				q(27202, {	-- Brother Against Brother
					...
					["qg"] = 45165,	-- Thurman Grant
					["coord"] = { 39.8, 69.7, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
				...
				q(27163, {	-- Brute Strength (A)
					...
					["qg"] = 44453,	-- Thassarian
					["coord"] = { 41.0, 70.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
						objective(1, {	-- 0/1 Rattlegore slain
							["provider"] = { "n", 44318 },	-- Rattlegore
							["coord"] = { 43.4, 69.6, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				q(27117, {	-- Brute Strength (H)
					...
					["qg"] = 44452,	-- Koltira Deathweaver
					["coord"] = { 47.7, 65.1, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
						objective(1, {	-- 0/1 The Ravenian slain
							["provider"] = { "n", 44317 },	-- The Ravenian
							["coord"] = { 46.6, 71.6, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				-- #if SEASON_OF_DISCOVERY
				...
				applyclassicphase(SOD_PHASE_FOUR, q(83935, {	-- Clearing the Path
					...
					["coord"] = { 47.8, 50.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_1_15_3 },
					["classes"] = { PALADIN },
					["lvl"] = 50,
					["groups"] = {
				...
				q(27174, {	-- Combat Training (A)
					...
					["qg"] = 45165,	-- Thurman Grant
					["coord"] = { 53.8, 64.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
						objective(1, {	-- 0/1 Gory slain
							["provider"] = { "n", 45212 },	-- Gory
							["coord"] = { 54.0, 65.8, MAP.WESTERN_PLAGUELANDS },
						}),
				...
				q(26938, {	-- Combat Training (H)
					...
					["coord"] = { 40.6, 52.0, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
				...
				q(27054, {	-- Desperate Acts
					...
					["groups"] = {
						objective(1, {	-- 0/1 Cult Orders
							...
							["coord"] = { 66.0, 48.6, MAP.WESTERN_PLAGUELANDS },
				...
				q(27157, {	-- Drudges... <Sigh>
					...
					["coord"] = { 43.2, 15.9, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["groups"] = {
						objective(1, {	-- 0/1 Shadril slain
							["provider"] = { "n", 45156 },	-- Shadril
							["coord"] = { 45.6, 9.4, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				q(26933, {	-- Foes Before Hoes
					...
					["coord"] = { 83.3, 69.8, MAP.TIRISFAL_GLADES },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["lvl"] = 35,
					["groups"] = {
				...
				q(27053, {	-- Gahrron's Withering Cauldron
					...
					["groups"] = {
						objective(1, {	-- 0/1 Gahrron's Withering Cauldron Key
							...
							["coord"] = { 62.6, 58.8, MAP.WESTERN_PLAGUELANDS },
				...
				q(27166, {	-- Go Fletch!
					...
					["groups"] = {
						objective(1, {	-- 0/9 Brownfeather Quill
							...
							["coord"] = { 37.6, 80.0, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				q(26956, {	-- I Ain't Sayin' You a Gourd-Digger...
					...
					["groups"] = {
						objective(1, {	-- 0/6 Bad Corn Removed
							...
							["coord"] = { 45.8, 53.4, MAP.WESTERN_PLAGUELANDS },
						}),
						objective(2, {	-- 0/4 Rotten Apple Removed
							...
							["coord"] = { 46.4, 54.2, MAP.WESTERN_PLAGUELANDS },
						}),
						objective(3, {	-- 0/3 Unhealthy-Looking Pumpkin Removed
							...
							["coord"] = { 47.6, 53.2, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				-- #if SEASON_OF_DISCOVERY
				applyclassicphase(SOD_PHASE_FOUR, q(83808, {	-- In A Bind
					...
					["groups"] = {
						objective(1, {	-- 0/1 Squire Cuthbert's Blade
							...
							["coord"] = { 45.7, 53.9, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				})),
				-- #endif
				...
				q(26934, {	-- Latent Disease
					...
					["groups"] = {
						objective(1, {	-- 0/20 Plague Tangle
							...
							["coord"] = { 34.6, 64.6, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				q(26936, {	-- Lower the Boom
					...
					["qg"] = 10837,	-- High Executor Derrington
					["coord"] = { 83.3, 69.0, MAP.TIRISFAL_GLADES },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["lvl"] = 35,
				}),
				...
				q(27017, {	-- Memories from a Lost Past
					...
					["coord"] = { 50.6, 52.5, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["groups"] = {
						objective(1, {	-- 0/1 Gahrron Prayer Book
							...
							["coord"] = { 64.9, 59.5, MAP.WESTERN_PLAGUELANDS },
						}),
				...
				q(10590, {	-- Prove Your Hatred
					...
					["qg"] = 17099,	-- Mehlar Dawnblade
					["coord"] = { 83.2, 71.2, MAP.TIRISFAL_GLADES },
					["timeline"] = { ADDED_2_0_1, REMOVED_4_0_3 },
					["maps"] = { MAP.UNDERCITY },
					["cost"] = { { "i", 12840, 20 } },	-- Minion's Scourgestone
					["classes"] = { PALADIN },
				...
				q(27011, {	-- Redpine Thievery
					...
					["groups"] = {
						objective(1, {	-- 0/10 Northridge Lumber
							...
							["coord"] = { 47.3, 41.2, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				q(27057, {	-- Return to the Stead
					...
					["coord"] = { 62.5, 58.5, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
				}),
				...
				q(27162, {	-- Scholomancer (A)
					...
					["groups"] = {
						objective(1, {	-- Darkmaster Gandling dealt with
							...
							["coord"] = { 45.2, 72.6, MAP.WESTERN_PLAGUELANDS },
						}),
				...
				q(26921, {	-- Scourge First... Alliance Later
					...
					["qg"] = 44452,	-- Koltira Deathweaver
					["coord"] = { 47.7, 65.2, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
				...
				q(27198, {	-- Supporting the Troops (A)
					...
					["coord"] = { 40.0, 69.1, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
				...
				q(27085, {	-- Supporting the Troops (H)
					...
					["coord"] = { 46.8, 63.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
				...
				q(26957, {	-- The Long Trip Home
					...
					["coord"] = { 42.6, 14.9, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
				}),
				...
				q(27175, {	-- The Menders' Stead [A]
					...
					["qg"] = 10840,	-- Argent Officer Pureheart
					["coord"] = { 42.9, 83.5, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["isBreadcrumb"] = true,
				}),
				q(26952, {	-- The Menders' Stead [H]
					...
					["qg"] = 10839,	-- Argent Officer Garush
					["coord"] = { 83.1, 68.4, MAP.TIRISFAL_GLADES },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
				...
				q(27168, {	-- Those That Couldn't Let Go
					...
					["qg"] = 11053,	-- High Priestess MacDonnell
					["coord"] = { 43.4, 83.7, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = ALLIANCE_ONLY,
					["groups"] = {
				...
				q(27152, {	-- Unusual Behavior... Even For Gnolls
					...
					["groups"] = {
						objective(1, {	-- 0/1 Moldfang slain
							...
							["coord"] = { 57.2, 35.4, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				q(27169, {	-- Uther's Blessing
					...
					["groups"] = {
						objective(1, {	-- Uther's blessing
							...
							["coord"] = { 52.0, 82.8, MAP.WESTERN_PLAGUELANDS },
						}),
					},
				}),
				...
				q(26923, {	-- War Machines (H)
					["qg"] = 44466,	-- Lindsay Ravensun
					["coord"] = { 47.5, 65.5, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_4_0_3 },
					["races"] = HORDE_ONLY,
					["groups"] = {
						objective(1, {	-- 0/6 Opengut Behemoth slain
				...
				q(26978, {	-- Who Needs Cauldrons?
					...
					["groups"] = {
						objective(1, {	-- Leave Drum near Windmill
							...
							["coord"] = { 37.27, 56.30, MAP.WESTERN_PLAGUELANDS },
						}),
						objective(2, {	-- Leave Drum near Grain Silos
							["provider"] = { "i", 60753 },	-- Dithers' Plague Drums
							["coord"] = { 36.88, 54.17, MAP.WESTERN_PLAGUELANDS },
						}),
						objective(3, {	-- Leave Drum inside Ranch House
							["provider"] = { "i", 60753 },	-- Dithers' Plague Drums
							["coord"] = { 38.10, 54.52, MAP.WESTERN_PLAGUELANDS },
						}),
						objective(4, {	-- Leave Drum inside Barn
							["provider"] = { "i", 60753 },	-- Dithers' Plague Drums
							["coord"] = { 38.60, 55.20, MAP.WESTERN_PLAGUELANDS },
						}),
			...
			n(RARES, {
				n(50345, {	-- Alit
					["coord"] = { 31.8, 72.2, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				n(51058, {	-- Aphis
					["coord"] = { 62.6, 35.4, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				-- #if BEFORE 4.0.3
				...
				-- #endif
				n(1849, {	-- Dreadwhisper
					["coord"] = { 64.0, 56.6, MAP.WESTERN_PLAGUELANDS },
				...
				n(1847, {	-- Foulmane
					-- #if AFTER CATA
					["coord"] = { 54.0, 80.4, MAP.WESTERN_PLAGUELANDS },
					-- #else
					["coords"] = {
				...
				n(50937, {	-- Hamhide
					["coord"] = { 43.6, 36.0, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				n(50809, {	-- Heress
					["coord"] = { 35.2, 53.2, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				n(50778, {	-- Ironweb
					["coord"] = { 51.8, 69.2, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_2_0 },
				}),
				n(1848, {	-- Lord Maldazzar
					-- #if AFTER CATA
					["coord"] = { 65.6, 47.6, MAP.WESTERN_PLAGUELANDS },
					-- #else
					["coords"] = {
				...
				n(50931, {	-- Mange
					["coord"] = { 66.2, 55.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_2_0 },
				}),
				n(50906, {	-- Mutilax
					["coord"] = { 52.6, 27.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				n(51029, {	-- Parasitus
					["coord"] = { 62.0, 73.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_2_0 },
				}),
				n(1850, {	-- Putridius
					-- #if AFTER CATA
					["coord"] = { 69.6, 73.2, MAP.WESTERN_PLAGUELANDS },
					-- #else
					["coords"] = {
				...
				n(1841, {	-- Scarlet Executioner
					-- #if AFTER CATA
					["coord"] = { 50.8, 40.6, MAP.WESTERN_PLAGUELANDS },
					-- #else
					["coords"] = {
				...
				n(1839, {	-- Scarlet High Clerist
					["coords"] = {
						-- #if AFTER CATA
						{ 41.6, 53.2, MAP.WESTERN_PLAGUELANDS },
						-- #else
						{ 55.0, 23.6, MAP.WESTERN_PLAGUELANDS },
						-- #endif
					},
				}),
				n(1838, {	-- Scarlet Interrogator
					["coords"] = {
						-- #if AFTER CATA
						{ 45.0, 52.0, MAP.WESTERN_PLAGUELANDS },
						-- #else
				...
				n(1837, {	-- Scarlet Judge
					["coords"] = {
						-- #if AFTER CATA
						{ 69.2, 49.8, MAP.WESTERN_PLAGUELANDS },
						-- #else
				...
				n(1885, {	-- Scarlet Smith
					["coords"] = {
						-- #if AFTER CATA
						{ 53.8, 44.2, MAP.WESTERN_PLAGUELANDS },
						-- #else
				...
				n(1851, {	-- The Husk
					["coords"] = {
						-- #if AFTER CATA
						{ 64.0, 83.6, MAP.WESTERN_PLAGUELANDS },
						-- #else
				...
				n(51031, {	-- Tracker
					["coord"] = { 62.6, 47.6, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_5_1_0 },
				}),
				n(50922, {	-- Warg
					["coords"] = {
						{ 57.0, 63.4, MAP.WESTERN_PLAGUELANDS },
						{ 57.2, 60.6, MAP.WESTERN_PLAGUELANDS },
					},
					["timeline"] = { ADDED_5_2_0 },
				}),
			}),
			...
			n(TREASURES, {
				applyclassicphase(SOD_PHASE_FOUR, i(226413, {	-- Rune of Arcane Specialization
					...
					["coord"] = { 47.3, 13.7, MAP.WESTERN_PLAGUELANDS },
					["timeline"] = { ADDED_1_15_3 },
				...
				applyclassicphase(SOD_PHASE_ONE, i(210322, {	-- Rune of Venom
					...
					["coord"] = { 59.4, 84.6, MAP.WESTERN_PLAGUELANDS },
